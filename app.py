...
with st.sidebar:
    ...
    # 페이지 파일명과 정확히 맞춰야 함
    st.page_link("pages/MAIN.py", label="🏠 메인화면", icon="🏠")
    st.page_link("pages/- 등기부등본_통합분석기.py", label="🧾 등기부등본 통합분석기", icon="🧾")
    st.page_link("pages/- 관리카드_자동작성.py", label="📄 관리카드 자동작성", icon="📄")
